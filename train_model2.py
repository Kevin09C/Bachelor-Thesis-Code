...
# workbook = xlsxwriter.Workbook('cellsepochs2.xlsx')
...
#for item in hist.history['accuracy']:

#    worksheet.write(row, col, item)
#    row += 1
#row = 1
#col = 1
#for item in hist.history['val_accuracy']:
...
plt.plot(np.arange(0, 2), H.history["accuracy"], label="accuracy")
plt.plot(np.arange(0, 2), H.history["val_accuracy"], label="val_accuracy")
